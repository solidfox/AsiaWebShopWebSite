...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <p>
        ...
        DeleteCommand="DELETE FROM [Address] WHERE [userName] = @userName AND [nickname] = @nickname AND [nickname] != 'Mailing' AND [userName] IN (SELECT [userName] FROM [Address] GROUP BY [userName] HAVING COUNT(*) > 1)" 
